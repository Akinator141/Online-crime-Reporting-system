...
<body style="color: black;background-image: url(policelogin.jpg);background-size: 100%;background-repeat: no-repeat;">
 ...
 <div  align="center" >
  ...
  <div class="form-group" style="width: 30%">
    <label for="exampleInputEmail1"  ><h1 style="color:#171315">Police Id</h1></label>
  ...
  <div class="form-group" style="width:30%">
    <label for="exampleInputPassword1"><h1 style="color:#171315">Password</h1></label>
