...
if(isset($_POST['s'])){
    ...
    {
        $message = "Police Station Appointed Successfully";
        echo "<script type='text/javascript'>alert('$message');</script>";
    }
    }
}
  ...
  <div class="container">
    ...
    <div id="navbar" class="collapse navbar-collapse">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li class="active"><a href="police_station_add.php">Appoint Police Station</a></li>
	...
	<div class="center-container">
		 <div class="bg-agile">
			...
			<div class="login-form"><p>
                <h2>Appoint Police Station</h2><br>
      ...
      Incharge Name
      <input type="text"  name="incharge_name" placeholder="incharge name" required="" id="station" onfocusout="f1()"/>
      compliaint id
					<input type="text"  name="compliant_id" placeholder="compliant id" required="" id="iname" onfocusout="f1()"/>
