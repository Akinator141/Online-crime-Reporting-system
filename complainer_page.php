...
if(isset($_POST['s'])){
    ...
    if($var>=0)
    {
      ...
      else
      {
          ...
          $query = "select c_id from complaint where a_no = $a_no";
          mysqli_select_db($conn,"crime_portal"); 
          $res=mysqli_query($conn,$query);

          $query1 = "select c_id from complaint order by c_id desc";
          ...
          $bodyContent .= "<p>Your Complaint has been registered successfully...<br> Your Complaint Registration ID is: $complaint</p>";
			...
			<div class="login-form"><p><h2 style="color:white">Welcome <?php echo "$u_name" ?></h2></p><br>
				...
				<div class="top-w3-agile" style="color: gray">Location of Crime
                    ...
                    <select class="form-control" name="location">
						<?php
                        $loc=mysqli_query($conn,"select city from cities");
